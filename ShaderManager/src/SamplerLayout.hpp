...
namespace SampleRender
{
	...
	public:
		SamplerElement();
		SamplerElement(SamplerFilter filter, AnisotropicFactor anisotropicFactor, AddressMode addressMode, ComparisonPassMode comparisonPassMode, uint32_t bindingSlot);
	...
	public:
		...
		const SamplerElement& GetElement(uint32_t bindingSlot);
