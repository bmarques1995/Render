...
void SampleRender::JPEGImage::LoadJPEGFromMemory(const std::byte* data, size_t size)
{
	jpeg_decompress_struct cinfo;
	jpeg_error_mgr jerr;
...
void SampleRender::JPEGImage::LoadJPEGPointers(jpeg_decompress_struct* cInfo, jpeg_error_mgr* jErr, FILE** content)
{
...
void SampleRender::JPEGImage::LoadJPEGPointers(jpeg_decompress_struct* cInfo, jpeg_error_mgr* jErr, const std::byte* data, size_t size)
{
	cInfo->err = jpeg_std_error(jErr);
	jpeg_create_decompress(cInfo);
...
void SampleRender::JPEGImage::DecompressJPEGImage(jpeg_decompress_struct* cInfo)
{
...
void SampleRender::JPEGImage::UnloadJPEGPointers(jpeg_decompress_struct* cInfo, jpeg_error_mgr* jErr)
{
