...
const std::unordered_map<std::string_view, SampleRender::ImageFormat> SampleRender::Image::s_ValidFormats =
{
	{"png", ImageFormat::PNG},
...
unsigned char* SampleRender::Image::GetRawPointer() const
{
	return m_Data;
}

uint32_t SampleRender::Image::GetWidth() const
{
	return m_Width;
}

uint32_t SampleRender::Image::GetHeight() const
{
	return m_Height;
}

uint32_t SampleRender::Image::GetChannels() const
{
	return m_Channels;
}

uint32_t SampleRender::Image::GetMips() const
{
...
SampleRender::ImageFormat SampleRender::Image::GetImageFormat(std::string_view path)
{
	ImageFormat format;
...
void SampleRender::Image::CastBMPToPNG(const unsigned char* pixels, uint32_t width, uint32_t height, unsigned char** buffer, size_t* bufferSize, bool flipVertically)
{
...
void SampleRender::Image::CastBMPToJPEG(const unsigned char* pixels, uint32_t width, uint32_t height, unsigned char** buffer, size_t* bufferSize, uint32_t quality, bool flipVertically)
{
