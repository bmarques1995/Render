...
namespace SampleRender
{
	...
	private:
		...
		Eigen::Vector<float, 9> vBuffer[6] =
		{
			{ -.5f, -.5f, .2f,  .0f, 1.0f, .0f, 1.0f,  0.0f, 1.0f },
			{ -.5f, .5f, .2f,  .0f, .0f, 1.0f, 1.0f,  0.0f, 0.0f },
			{ .5f, -.5f, .2f,  1.0f, .0f, 1.0f, 1.0f,  1.0f, 1.0f },
			{ .5f, .5f, .2f,  1.0f, .0f, .0f, 1.0f,  1.0f, 0.0f },
		};
