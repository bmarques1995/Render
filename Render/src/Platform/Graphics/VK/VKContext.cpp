...
const std::vector<const char*> SampleRender::VKContext::s_ValidationLayers =
{
    "VK_LAYER_KHRONOS_validation"
};

bool SampleRender::VKContext::CheckValidationLayerSupport()
{
    uint32_t layerCount;
...
const std::vector<const char*> SampleRender::VKContext::deviceExtensions =
{
...
void SampleRender::VKContext::SetClearColor(float r, float g, float b, float a)
{
...
void SampleRender::VKContext::Present()
{
    VkSemaphore signalSemaphores[] = { m_RenderFinishedSemaphores[m_CurrentBufferIndex] };
...
void SampleRender::VKContext::StageViewportAndScissors()
{
...
void SampleRender::VKContext::Draw(uint32_t elements)
{
    vkCmdDrawIndexed(m_CommandBuffers[m_CurrentBufferIndex], elements, 1, 0, 0, 0);
}

const std::string SampleRender::VKContext::GetGPUName()
{
...
void SampleRender::VKContext::WindowResize(uint32_t width, uint32_t height)
{
    vkDeviceWaitIdle(m_Device);
...
void SampleRender::VKContext::CreateSurface(const Window* windowHandle)
{
    VkResult vkr;
...
void SampleRender::VKContext::SelectAdapter()
{
    VkResult vkr;
...
bool SampleRender::VKContext::IsDeviceSuitable(VkPhysicalDevice adapter)
{
...
SampleRender::QueueFamilyIndices SampleRender::VKContext::FindQueueFamilies(VkPhysicalDevice adapter)
{
...
bool SampleRender::VKContext::CheckDeviceExtensionSupport(VkPhysicalDevice adapter)
{
...
SampleRender::SwapChainSupportDetails SampleRender::VKContext::QuerySwapChainSupport(VkPhysicalDevice adapter)
{
...
void SampleRender::VKContext::CreateSwapChain()
{
    VkResult vkr;
...
VkSurfaceFormatKHR SampleRender::VKContext::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR SampleRender::VKContext::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D SampleRender::VKContext::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void SampleRender::VKContext::CleanupSwapChain()
{
...
void SampleRender::VKContext::CreateImageView()
{
    VkResult vkr;
...
void SampleRender::VKContext::CleanupImageView()
{
    for (size_t i = 0; i < m_SwapChainImageCount; i++)
    {
...
void SampleRender::VKContext::CreateRenderPass()
{
    VkResult vkr;
...
void SampleRender::VKContext::CreateFramebuffers()
{
    VkResult vkr;
...
void SampleRender::VKContext::CleanupFramebuffers()
{
    for (size_t i = 0; i < m_SwapChainImageCount; i++)
    {
...
void SampleRender::VKContext::CreateCommandBuffers()
{
    VkResult vkr;
...
void SampleRender::VKContext::CreateSyncObjects()
{
    VkResult vkr;
...
void SampleRender::VKContext::SetupDebugMessage()
{
    VkResult VKR;
...
void SampleRender::VKContext::PopulateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo = {};
...
VkResult SampleRender::VKContext::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger)
{
...
void SampleRender::VKContext::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator)
{
