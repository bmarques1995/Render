...
SampleRender::D3D12Buffer::D3D12Buffer(const std::shared_ptr<D3D12Context>* context) :
	m_Context(context)
{
}

void SampleRender::D3D12Buffer::CreateBuffer(const void* data, size_t size)
{
	HRESULT hr;
...
SampleRender::D3D12IndexBuffer::D3D12IndexBuffer(const std::shared_ptr<D3D12Context>* context, const void* data, size_t count) :
	D3D12Buffer(context)
{
...
uint32_t SampleRender::D3D12IndexBuffer::GetCount() const
{
	return m_Count;
}
